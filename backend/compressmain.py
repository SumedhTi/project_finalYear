...
def compress_image_bytes_to_jpeg(image_bytes: bytes, quality: int = 70) -> bytes:
    """Compress image bytes to JPEG with given quality."""
    try:
    ...
    # JPEG supports RGB and L (grayscale), but not alpha or palette modes
